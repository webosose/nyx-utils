 ...
 * @file nyx_cmd_gps.h
 *
 * @brief Implementation class for nyx-cmd Gps device type.
 *
 */
...
class NyxCmdGps : public NyxCmdDeviceType
{
	/**
	* @defgroup nyx_cmd_gps_module nyx-cmd Gps module
	* @ingroup nyx_cmd_modules
	* @defgroup nyx_cmd_gps_devicetype nyx-cmd Gps device type implementation
