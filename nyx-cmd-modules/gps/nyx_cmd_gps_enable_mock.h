...
#ifndef NYXCMDGPSENABLEMOCK_H
#define NYXCMDGPSENABLEMOCK_H

/**
 * @file nyx_cmd_gps_enable_mock.h
 *
 * @brief Implementation class for nyx-cmd Gps device type enablemock command.
 *
 */

#include <nyx/nyx_client.h>

class NyxCmdGpsEnableMock : public NyxCmdCommand
{
	/**
	* @defgroup nyx_cmd_gps_enable_mock nyx-cmd Gps device type enable mock command
...
private:
	 ...
	 *
	 * @return int Gps Mock to be enable, -1 if error
	 *
	 */
