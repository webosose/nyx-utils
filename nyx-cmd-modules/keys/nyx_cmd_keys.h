 ...
 * @file nyx_cmd_keys.h
 *
 * @brief Implementation class for nyx-cmd Keys device type.
 *
 */
...
class NyxCmdKeys : public NyxCmdDeviceType
{
	/**
	* @defgroup nyx_cmd_keys_module nyx-cmd Keys module
	* @ingroup nyx_cmd_modules
	* @defgroup nyx_cmd_keys_devicetype nyx-cmd Keys device type implementation
	* @ingroup nyx_cmd_keys_module
	* @{
	*/
protected:
	/**
