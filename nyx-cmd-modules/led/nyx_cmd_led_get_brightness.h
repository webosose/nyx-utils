...
#ifndef NYXCMDLEDGETBRIGHTNESS_H
#define NYXCMDLEDGETBRIGHTNESS_H

/**
 * @file nyx_cmd_led_get_brightness.h
 *
 * @brief Implementation class for nyx-cmd Led device type get brightness command.
 *
 */

#include <nyx/nyx_client.h>

class NyxCmdLedGetBrightness : public NyxCmdCommand
{
	/**
	* @defgroup nyx_cmd_led_get_brightness nyx-cmd Led device type get brightness command
...
#endif // NYXCMDLEDGETBRIGHTNESS_H
