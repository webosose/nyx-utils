...
#ifndef NYXCMDSYSTEMQUERYALARM_H
#define NYXCMDSYSTEMQUERYALARM_H

/**
 * @file nyx_cmd_system_query_alarm.h
 *
 * @brief Implementation class for nyx-cmd System device type query alarm command.
 *
 */
...
class NyxCmdQueryAlarm : public NyxCmdCommand
{
	/**
	* @defgroup nyx_cmd_system_query_alarm nyx-cmd System device type query alarm command
...
#endif // NYXCMDSYSTEMQUERYALARM_H
