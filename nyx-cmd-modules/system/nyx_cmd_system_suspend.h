...
#ifndef NYXCMDSYSTEMSUSPEND_H
#define NYXCMDSYSTEMSUSPEND_H

/**
 * @file nyx_cmd_system_suspend.h
 *
 * @brief Implementation class for nyx-cmd System device type suspend command.
 *
 */
...
class NyxCmdSystemSuspend : public NyxCmdCommand
{
	/**
	* @defgroup nyx_cmd_system_suspend nyx-cmd System device type suspend command
