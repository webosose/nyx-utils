...
#ifndef NYX_TOUCH_PANEL_ACTIVESCANRATE_GET_H
#define NYX_TOUCH_PANEL_ACTIVESCANRATE_GET_H
...
class NyxCmdTouchPanelGetActiveScanRate : public NyxCmdCommand
{
	/**
	* @defgroup nyx_cmd_touchpanel_get_mode nyx-cmd TouchPanel device type set mode command
...
public:
	 ...
	 *
	 */
	NyxCmdTouchPanelGetActiveScanRate(void);
...
#endif // NYX_TOUCH_PANEL_ACTIVESCANRATE_GET_H
