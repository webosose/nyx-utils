...
#ifndef NYX_TOUCH_PANEL_GETEVENT_H
#define NYX_TOUCH_PANEL_GETEVENT_H

/**
 * @file nyx_cmd_touchpanel_get_event.h
 *
 * @brief Implementation class for nyx-cmd TouchPanel device type get mode command.
 *
 */
...
class NyxCmdTouchPanelGetEvent : public NyxCmdCommand
{
	/**
	* @defgroup nyx_cmd_touchpanel_get_event nyx-cmd TouchPanel device type set mode command
...
private:
	 ...
	 *
	 * @return int TouchPanel mode to be get, -1 if error
	 *
	 */
...
public:
	...
	*/
	...
	/**
	* Read the touch events .
	*
	* @return bool value for successful read of touch events.
	*/
	bool readTouchEventData(nyx_device_handle_t handle);

};

#endif // NYX_TOUCH_PANEL_GETEVENT_H
