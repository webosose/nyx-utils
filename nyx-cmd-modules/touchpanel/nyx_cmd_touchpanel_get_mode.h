...
#ifndef NYX_TOUCH_PANEL_GETMODE_H
#define NYX_TOUCH_PANEL_GETMODE_H

/**
 * @file nyx_cmd_touchpanel_get_mode.h
 *
...
class NyxCmdTouchPanelGetMode : public NyxCmdCommand
{
	/**
	* @defgroup nyx_cmd_touchpanel_get_mode nyx-cmd TouchPanel device type get mode command
...
#endif // NYX_TOUCH_PANEL_GETMODE_H
