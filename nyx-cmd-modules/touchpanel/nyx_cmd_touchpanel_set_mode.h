...
#ifndef NYX_TOUCH_PANEL_SETMODE_H
#define NYX_TOUCH_PANEL_SETMODE_H

/**
 * @file nyx_cmd_touchpanel_set_mode.h
 *
...
class NyxCmdTouchPanelSetMode : public NyxCmdCommand
{
	/**
...
#endif // NYX_TOUCH_PANEL_SETMODE_H
